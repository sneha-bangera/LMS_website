...
const CourseDetails = () => {
    ...
    const [courseLec, setCourseLec]= useState(null)
                        ...
                        <Card>
                            <CardContent className="p-4 flex flex-col">
                                <div className="w-full aspect-video mb-4">
                                    <ReactPlayer width='100%' height='100%' url={courseLec? courseLec[0]?.videoUrl : null} controls={true}/>
                                </div>

                                <h1>{courseLec? courseLec[0]?.lectureTitle: "Lecture Title"}</h1>
